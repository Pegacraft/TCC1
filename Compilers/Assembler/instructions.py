...
def create_opcodes(instruction: str, r: int, s: int, t: int, i: int):
    instructions: dict = {
        ...
        "addi": (0x90, (r, 1), 0x00, (t, 1), (i, 4)),
        "sub": (0x81, (r, 1), (s, 1), (t, 1), (0, 4)),
        "subi": (0x91, (r, 1), 0x00, (t, 1), (i, 4)),
        "mul": (0x82, (r, 1), (s, 1), (t, 1), (0, 4)),
        "muli": (0x92, (r, 1), 0x00, (t, 1), (i, 4)),
        "and": (0x83, (r, 1), (s, 1), (t, 1), (0, 4)),
        "andi": (0x93, (r, 1), 0x00, (t, 1), (i, 4)),
        "or": (0x84, (r, 1), (s, 1), (t, 1), (0, 4)),
        "ori": (0x94, (r, 1), 0x00, (t, 1), (i, 4)),
        "not": (0x85, (r, 1), 0x00, (t, 1), (0, 4)),
        "xor": (0x86, (r, 1), (s, 1), (t, 1), (0, 4)),
        "xori": (0x96, (r, 1), 0x00, (t, 1), (i, 4)),
        "xnor": (0x87, (r, 1), (s, 1), (t, 1), (0, 4)),
        "xnori": (0x97, (r, 1), 0x00, (t, 1), (i, 4)),
        "nor": (0x88, (r, 1), (s, 1), (t, 1), (0, 4)),
        "nori": (0x98, (r, 1), 0x00, (t, 1), (i, 4)),
        "ceq": (0x89, (r, 1), (s, 1), (t, 1), (0, 4)),
        "ceqi": (0x99, (r, 1), 0x00, (t, 1), (i, 4)),
        "clt": (0x8A, (r, 1), (s, 1), (t, 1), (0, 4)),
        "clti": (0x9A, (r, 1), 0x00, (t, 1), (i, 4)),
        "clte": (0x8B, (r, 1), (s, 1), (t, 1), (0, 4)),
        "cltei": (0x9B, (r, 1), 0x00, (t, 1), (i, 4)),
        "shr": (0x8C, (r, 1), (s, 1), (t, 1), (0, 4)),
        "shri": (0x9C, (r, 1), 0x00, (t, 1), (i, 4)),
        "shl": (0x8D, (r, 1), (s, 1), (t, 1), (0, 4)),
        "shli": (0x9D, (r, 1), 0x00, (t, 1), (i, 4)),
        "rr": (0x8E, (r, 1), (s, 1), (t, 1), (0, 4)),
        "rri": (0x9E, (r, 1), 0x00, (t, 1), (i, 4)),
        "rl": (0x8F, (r, 1), (s, 1), (t, 1), (0, 4)),
        "rli": (0x9F, (r, 1), 0x00, (t, 1), (i, 4)),

        #Memory
        "lw": (0x40, 0x00, (r, 1), (s,1), (t, 4)),
        "lwi": (0x50, 0x00, (r, 1), (s, 1), (i, 4)),
